...
function Public.reset()
    ...
    this.car_areas = {
        ['car'] = {left_top = {x = -32, y = -32}, right_bottom = {x = 32, y = 32}},
        ['tank'] = {left_top = {x = -48, y = -48}, right_bottom = {x = 48, y = 48}},
        ['spidertron'] = {left_top = {x = -64, y = -64}, right_bottom = {x = 64, y = 64}},
        ['spider-vehicle'] = {left_top = {x = -64, y = -64}, right_bottom = {x = 64, y = 64}}
    }
end
