...
local this = {
    ...
    difficulty_poll_closing_timeout = 0,
...
function Public.reset_difficulty_poll(tbl)
    if tbl then
        ...
        this.difficulty_poll_closing_timeout = tbl.difficulty_poll_closing_timeout or game.tick
        ...
        this.difficulty_poll_closing_timeout = game.tick
        for _, p in pairs(game.connected_players) do
            if p.gui.center['difficulty_poll'] then
                p.gui.center['difficulty_poll'].destroy()
            end
