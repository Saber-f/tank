...
local this = {
    ...
    valid_turrets = {
        ...
        -- ['shotgun-ammo-turret-rampant-arsena'] = true,
    },
    valid_ammo = {
        ['firearm-magazine']         = {valid = true, priority = 1}, -- 标准
        ['piercing-rounds-magazine'] = {valid = true, priority = 2}, -- 穿甲
        ['bullet-magazine']= {valid = true, priority = 3}, -- 标准b
        ['uranium-rounds-magazine']  = {valid = true, priority = 4}, -- 贫油
        ['acid-bullet-magazine']     = {valid = true, priority = 4}, -- 酸蚀
        ['ap-bullet-magazine']       = {valid = true, priority = 4}, -- 穿甲b
        ['electric-bullet-magazine'] = {valid = true, priority = 4}, -- 电浆
        ['flame-bullet-magazine']    = {valid = true, priority = 4}, -- 燃烧
        ['he-bullet-magazine']       = {valid = true, priority = 4}, -- 高爆
        ['poison-bullet-magazine']   = {valid = true, priority = 4}, -- 毒素
        -- ['plasma-bullet-magazine']   = {valid = true, priority = 5}, -- 等离子

        ['shotgun-shell']          = {valid = true, priority = 1}, -- 标准
        ['piercing-shotgun-shell'] = {valid = true, priority = 2}, -- 穿甲
        ['better-shotgun-shell']   = {valid = true, priority = 3}, -- 标准b
        ['shotgun-uranium-shell']  = {valid = true, priority = 4}, -- 辐射
        ['shotgun-acid-shell']     = {valid = true, priority = 4}, -- 酸蚀
        ['shotgun-ap-shell']       = {valid = true, priority = 4}, -- 穿甲
        ['shotgun-electric-shell'] = {valid = true, priority = 4}, -- 电浆
        ['shotgun-flame-shell']    = {valid = true, priority = 4}, -- 燃烧
        ['shotgun-he-shell']       = {valid = true, priority = 4}, -- 高爆
        ['shotgun-poison-shell']   = {valid = true, priority = 4}, -- 毒素
        -- ['shotgun-plasma-shell']   = {valid = true, priority = 5}, -- 等离子
    },
    message_limit = {},
    player_settings = {},
...
local function auto_insert_into_turret(player, turret)
    ...
    local ret =
        ...
        inventory,
        turret,
        {'firearm-magazine','piercing-rounds-magazine','bullet-magazine','uranium-rounds-magazine','acid-bullet-magazine','ap-bullet-magazine','electric-bullet-magazine','flame-bullet-magazine','he-bullet-magazine','poison-bullet-magazine',
    'shotgun-shell','piercing-shotgun-shell','better-shotgun-shell','shotgun-uranium-shell','shotgun-acid-shell','shotgun-ap-shell','shotgun-electric-shell','shotgun-flame-shell','shotgun-he-shell','shotgun-poison-shell'},
