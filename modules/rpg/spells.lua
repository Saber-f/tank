...
function Public.conjure_items()
    ...
    -- spells[#spells + 1] = { -- 召唤大宝贝
    --     name = '大宝贝',
    --     entityName = 'maf-boss-biter-10',
    --     level = 1,
    --     biter = true,
    --     type = 'entity',
    --     mana_cost = 5000,
...
Public.itam_spell = {
      ...
      ['lightning_chain'] = {max_range = 16, tick_speed = 1,lianxu=true,bonus=1,need_times=10,base=10},  -- 闪电链伤害
}
